...
def load_model(cfg: InferenceConfig) -> BaseModel:
    print('1sssstttttsssstttttttttttttttttt')
    ...
    if cfg.weight is not None:
        weight_path = (
            #"/home/unify/Project/kaggle-child-mind-institute-detect-sleep-states-main/output/train/exp001/single/best_model.pth"
...
def get_test_dataloader(cfg: InferenceConfig) -> DataLoader:
    print('2nddddddddddddddddddddddddddddddddd')
    """get test dataloader
...
def inference(
    ...
    print('fourrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrr')
...
def make_submission(
    ...
    print('fiveeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee')
    sub_df = post_process_for_seg(
        keys,
        preds[:, :, [0, 1]],  # type: ignore
        score_th=score_th,
...
def main(cfg: InferenceConfig):
    ...
    print('start the fraking process')
    ...
    #print(Path(cfg.dir.model_dir) /cfg.weight.run_name / "best_model.pth")
